...
class NotificationService {
  ...
  Future<void> showAiMessageNotification(
    ...
    // Уведомление НЕ отправляется, если приложение активно
    // Пользователь увидит сообщение в чате, уведомление не нужно
    final appLifecycleState = WidgetsBinding.instance.lifecycleState;
    if (appLifecycleState == AppLifecycleState.resumed) {
      // Приложение активно - не отправляем уведомление
      if (kDebugMode) {
        print('📱 [NotificationService] Приложение активно, уведомление не отправляется');
      }
      return;
    }
